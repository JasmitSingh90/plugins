...
/** Android platform implementation of the VideoPlayerPluginCustom. */
public class VideoPlayerPluginCustom implements FlutterPlugin, VideoPlayerApi {
  private static final String TAG = "VideoPlayerPluginCustom";
  private final LongSparseArray<VideoPlayer> videoPlayers = new LongSparseArray<>();
  private FlutterState flutterState;
  private VideoPlayerOptions options = new VideoPlayerOptions();

  /** Register this with the v2 embedding for the plugin to respond to lifecycle callbacks. */
  public VideoPlayerPluginCustom() {}

  @SuppressWarnings("deprecation")
  private VideoPlayerPluginCustom(io.flutter.plugin.common.PluginRegistry.Registrar registrar) {
    this.flutterState =
        new FlutterState(
            registrar.context(),
            registrar.messenger(),
  ...
  public static void registerWith(io.flutter.plugin.common.PluginRegistry.Registrar registrar) {
    final VideoPlayerPluginCustom plugin = new VideoPlayerPluginCustom(registrar);
  ...
  private static final class FlutterState {
    ...
    void startListening(VideoPlayerPluginCustom methodCallHandler, BinaryMessenger messenger) {
