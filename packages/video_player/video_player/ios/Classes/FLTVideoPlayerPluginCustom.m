...
#import "FLTVideoPlayerPluginCustom.h"
...
@interface FLTVideoPlayerPluginCustom () <FLTVideoPlayerApi>
...
@implementation FLTVideoPlayerPluginCustom
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
  FLTVideoPlayerPluginCustom* instance = [[FLTVideoPlayerPluginCustom alloc] initWithRegistrar:registrar];
